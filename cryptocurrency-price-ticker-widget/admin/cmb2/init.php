...
if ( ! class_exists( 'CMB2_Bootstrap_2101', false ) ) {
	...
	class CMB2_Bootstrap_2101 {
		...
		public function l10ni18n() {
			...
			if ( ! $loaded ) {
				$locale = apply_filters( 'plugin_locale', function_exists( 'determine_locale' ) ? determine_locale() : get_locale(), 'cmb2' );  // phpcs:ignore WordPress.NamingConventions.PrefixAllGlobals.NonPrefixedHooknameFound
